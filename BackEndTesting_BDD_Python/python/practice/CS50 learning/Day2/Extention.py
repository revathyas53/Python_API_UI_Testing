...
implement a program that prompts the user for the name of a file and then outputs that file’s media type if the file’s
...
def extentions():
    ...
    match extention.split(".")[1]:
        case "gif" | "jpeg" |"jpg"|"png":
            print("image/" + extention.split(".")[1])
        case "pdf":
