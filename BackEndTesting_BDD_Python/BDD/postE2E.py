...
print ("**** ADD BOOK ****")
addBook_response=requests.post(url+'/Library/Addbook.php', json=addPayload("099"), headers=header)
...
print("***** Delete Book ******")
deleteBook_response=requests.post(url+'/Library/DeleteBook.php', json={'ID': book_id}, headers=header,)
